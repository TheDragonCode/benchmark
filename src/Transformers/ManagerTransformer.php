...
class ManagerTransformer
{
    ...
    {
        return $this->resolve(TimesTransformer::class, $data);
    }

    public function forStats(array $data): array
    {
        return $this->resolve(StatsTransformer::class, $data);
    }

    public function forWinners(array $data): array
    {
        return $this->resolve(WinnerTransformer::class, $data);
    }

    public function separator(array $data): array
    {
        return $this->resolve(SeparatorTransformer::class, $data);
    }
